...
$config['DX_register_uri'] = '/account/register/';
$config['DX_forgot_password_uri'] = '/account/forgot_password/';
$config['DX_change_password_uri'] = '/account/change_password/';
$config['DX_cancel_account_uri'] = '/account/cancel_account/';
