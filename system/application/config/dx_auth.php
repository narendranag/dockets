...
$config['DX_website_name'] = 'Dockets';
$config['DX_webmaster_email'] = 'codemaster.snake@gmail.com';
...
$config['DX_autologin_cookie_name'] = 'dockets_autologin';
$config['DX_autologin_cookie_life'] = 60*60*24*14; // two weeks
...
$config['DX_captcha_height'] = 35;
$config['DX_captcha_font_size'] = '13';
...
$config['DX_register_uri'] = '/session/register/';
$config['DX_forgot_password_uri'] = '/session/forgot_password/';
$config['DX_change_password_uri'] = '/session/change_password/';
$config['DX_cancel_account_uri'] = '/session/cancel_account/';

// Forms view
$config['DX_login_view'] = 'session/login';
$config['DX_register_view'] = 'session/register';
$config['DX_forgot_password_view'] = 'session/forgot_password';
